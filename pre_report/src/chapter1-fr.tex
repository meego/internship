\section{État de l’art}
  ...
  \label{sec:memory}    
    ...
    \subsubsection{Solutions matérielles}
      ...
      \todo{Mettre l'explication de la limite des 64Go.}
    ...
    \subsubsection{Linux, OpenBSD et NetBSD}
      ...
      adressable\footnote{\todo{Trouver si c'est une convention ou si c'est
          POSIX}}.
      ...
      \subsubsection{Le cas FreeBSD}
        ...
        \todo{Après différents échanges\footnote{Le fil de discussion:
            \url{https://docs.freebsd.org/cgi/mid.cgi?db=irt&id=5526408F.1090005@asim.lip6.fr}}
          sur la mailing-liste \texttt{freebsd-questions}, la situation n'est
          toujours pas claire pour moi.}
