    ...
    \subsection{Hare}
      ...
      \begin{figure}[ht]
        ...
        \caption{Mécanisme de partage de descripteurs de fichier. Le
          ...
          l'applicatio 1, tandis que le \textit{file descriptor} 4 est partagé
      ...
      \texttt{exec()}\footnote{On pense notamment aux navigateurs web qui ont
        récemment changer leur gestion mémoire afin d'utiliser un processus par
        onglet et non un thread~\citep{}. \todo{Trouver une référence}}. En
      imposant la migration lors du \texttt{exec()}, on ne brise pas ce lien de
      parenté. Néanmoins, l'inconvénient majeur de cette solution est sa
      granularité. En choisissant de migrer des processus entiers et non un
      certain nombre de threads par processus, et en imposant la migration
      uniquement lors de l'appel à \texttt{exec()}, Hare ne permet pas la
      parallélisation massive des applications.
