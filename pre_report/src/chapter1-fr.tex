\chapter{État de l’art}
  ...
  \label{sec:memory}    
    ...
    \subsection{Physical Address Extension}
      ...
      PAE\nomenclature{PAE}{Physical Address Extension} (\textit{Physical
      ...
      \begin{figure}[ht]
        \centering \includegraphics[scale=0.55]{paging-no-pae}
      ...
      ce tableau (appelées PDE\nomenclature{PDE}{Page Directory Entry} pour
      ...
      PTE\nomenclature{PTE}{Page Table Entry}). Ces PTE contiennent le
      PFN\nomenclature{PFN}{Page Frame Number} (\textit{Page Frame Number}) de
      ...
      \begin{figure}[ht]
        \centering \includegraphics[scale=0.52]{paging-pae}
    ...
    \subsection{Large Physical Address Extension}
      ...
      \begin{itemize}
        ...
        \item un certaine quantité de RAM\nomenclature{RAM}{Random-Access
          Memory} pour le noyau
    ...
    \nomenclature{UNIX}{Uniplexed Information and Computing Service}
      ...
      La mémoire est découpée en pages. Ces pages peuvent être de grande taille
      ...
      \begin{paragraph}{Remarque:}
        Pour des raisons de performances, ALMOS évolue vers une taille de
        descripteurs de page de 64 octets, soit une ligne complète pour le cache
        de niveau L1. Cela a pour conséquence d'augmenter la place nécessaire
        pour décrire la mémoire.
      \end{paragraph}
  ...
  \label{sec:scalability}
    ...
    \subsection{Barrelfish}
      ...
      \begin{figure}[ht]
        \centering \includegraphics[scale=0.35]{barrelfish}
  ...
  \label{sec:consistency}
    ...
    \label{subsec:corey}
      ...
      Comme nous l'avons dit précédemment, Corey permet de manipuler très
    ...
    \subsection{Hare}
      ...
      \begin{figure}[ht]
        \centering
        \includegraphics[scale=0.24]{hare-design}
      ...
      processus.
      \enlargethispage{1mm} %% Ugly hack to avoid the final image on a single
                            %% blank page
    ...
    \subsection{Popcorn Linux}
      ...
      \begin{figure}[ht]
        \centering \includegraphics[scale=0.67]{popcorn-bench}
