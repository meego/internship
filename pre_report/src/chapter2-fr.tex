...
\label{sec:context}
  ...
  le LIP6, ont pour but de fournir une architecture de processeur, TSAR, de
  ...
  \label{sec:almos}
    ...
    problématique de la localité des accès mémoires dans les machines
  ...
  \section{Évolution du projet}
    ...
    \subsection{Contributions de François~\citeauthor{guerret2014exploitation}}
      ...
      \begin{paragraph}{Résultats:}
        ...
        y accéder. Cela allourdi considérablement l'opération, cette solution
        fût donc abandonnée. Néanmoins, elle a posée les bases de la version
        suivante d'ALMOS.
      \end{paragraph}
  ...
  \label{sec:multi-noyau}
    ...
    ensuite migrées via la stratégie \textit{Auto-Next-Touch\footnote{Non
        détaillée dans ce rapport. Voir~\citep{almaless2014universite}.}}.
