...
\label{sec:context}
  ...
  \section{Évolution du projet}
    ...
    \subsection{Limitations de la version initiale}
      ...
      espace virtuel. Contraitement aux noyaux ``classiques'', ALMOS s'accorde 2
      giga-octet d'espace virtuel au lieu de 1. Donc, si ce cluster possède (au
      moins) 2Go de mémoire physique, l'ensemble du noyau est mappé dans ce seul
    ...
    \subsection{Contributions de Francois \citeauthor{guerret2014exploitation}}
      ...
      \begin{paragraph}{Gestion en adressage physiques de structures de données:}
        ...
        dispose de sa propre table des pages. Il est techniquement impossible de
  ...
  \label{sec:multi-noyau}
    ...
    c\oe urs du même cluster est elle toujours fonctionnelle). Dans la version
