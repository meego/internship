...
\label{sec:context}
  ...
  TSAR~\cite{tsar2008} et SHARP~\cite{sharp2012}. Ce dernier a pour but de
  ...
  \label{sec:almos}
    ...
    \subsection{Les réplica noyau}
      ...
      %%     cluster~\citep{almaless2014universite}.}
      ...
      unique endroit en mémoire physique\footnote{Le cluster 0 par exemple, qui
        est utilisé au démarrage du système pour initialiser tous les réplica.},
      et que chaque processus mappe ces pages dans son espace virtuel, alors on
      paiera le coût de l'architecture NUMA à chaque appel système, puisque l'on
      devra accéder à des pages distantes.
  ...
  \section{Évolution du projet}
    ...
    \subsection{Limitations de la version initiale}
      ...
      supporter le téra-octet de mémoire apporté par TSAR\footnote{De
    ...
    \subsection{Contributions de Francois Guerret}
      ...
      \begin{paragraph}{Gestion en adressage physiques de structures de données:}
        ...
        noyau. Celle-ci a donc été sortie et est gérer en adressage physique.
      \end{paragraph}
      ...
      \begin{figure}[ht]
        ...
        \caption{Répartition de l'espace virtuel du noyau tel que proposé par
          Franćois Guerret~\citep{guerret2014exploitation}.}
  ...
  \label{sec:multi-noyau}
    ...
    Une des conséquences de ce choix est d'avoir rendu non fonctionnelle la
